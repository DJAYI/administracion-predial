...
public class TipoCondicionPredioService {
    ...
    public PaginatedResponse<PropertyTypeResponse> findAll(Pageable pageable, boolean includeDeletes) {
        Page<TipoCondicionPredio> page = repository.findAll(
    ...
    private TipoCondicionPredio getEntityById(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Property condition not found with id: " + id));
    }

    public PropertyTypeResponse create(PropertyConditionRequest request) {
        TipoCondicionPredio entity = new TipoCondicionPredio();
    ...
    public PropertyTypeResponse update(Long id, PropertyConditionRequest request) {
        TipoCondicionPredio entity = getEntityById(id);
        entity.setName(request.getName());
        entity.setDescription(request.getDescription());
        return mapToResponse(repository.save(entity));
    }
    ...
    private PropertyTypeResponse mapToResponse(TipoCondicionPredio entity) {

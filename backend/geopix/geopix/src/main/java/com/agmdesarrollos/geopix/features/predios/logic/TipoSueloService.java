...
public class TipoSueloService {
    ...
    public PaginatedResponse<PropertyTypeResponse> findAll(Pageable pageable, boolean includeDeletes) {
        Page<TipoSuelo> page = repository.findAll(
    ...
    private TipoSuelo getEntityById(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Soil type not found with id: " + id));
    }

    public PropertyTypeResponse create(SoilTypeRequest request) {
        TipoSuelo entity = new TipoSuelo();
    ...
    public PropertyTypeResponse update(Long id, SoilTypeRequest request) {
        TipoSuelo entity = getEntityById(id);
        entity.setName(request.getName());
        entity.setDescription(request.getDescription());
        return mapToResponse(repository.save(entity));
    }
    ...
    private PropertyTypeResponse mapToResponse(TipoSuelo entity) {
